        ...
        **/
        if(readability.getInnerText(articleContent, false).length < 250)
        {
            if (readability.flagIsActive(readability.FLAG_STRIP_UNLIKELYS)) {
                ...
                articleContent.innerHTML = "It appears <em>Mobile Readability</em> was not able to render this page." +
                    "<a onClick='javascript:window.location = link;'>View full version.</a>";
            }
        }
        ...
        **/
        if((window.location.protocol + "//" + window.location.host + "/") == window.location.href)
        {
            ...
            var rootWarning = document.createElement('p');
                ...
                rootWarning.innerHTML = "It appears <em>Mobile Readability</em> was not able to render this page." +
                    "<a onClick='javascript:window.location = link;'>View full version.</a>";
...
//        document.body.style.display = "block";
    ...
    getArticleTools: function () {
        ...
        articleTools.innerHTML = 
            "<a href='#' onclick='return window.location = link' title='Reload original page' id='reload-page'>Reload Original Page</a>";
    ...
    getArticleFooter: function () {
        ...
        var twitterLink = document.createElement('a');
            ...
            twitterLink.innerHTML = "Follow me on Twitter &raquo;";
        ...
        articleFooter.innerHTML = 
            "<div id='rdb-footer-left'>" +
                ...
                "<a href='http://www.twitter.com/johnturner' class='footer-twitterLink'>Follow me on Twitter &raquo;</a>" +
            "</div>" +
            "<div id='rdb-footer-right'>" +
                "<a href='http://www.twitter.com/johnturner' class='footer-twitterLink'>Follow me on Twitter &raquo;</a>" +
                "<span class='version'>Readability version " + readability.version + "</span>" +
            "</div>" +
            "<div id='johndturner-url'> mobile version by <a href='http://johndturner.com'>John Turner</a></div>"
            ;
